...
use NowyBundle\Entity\Package;
use NowyBundle\Form\PackageType;
...
class PackageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NowyBundle:Package')->findAll();
     ...
     * @Method("POST")
     * @Template("NowyBundle:Package:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NowyBundle:Package')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NowyBundle:Package:edit.html.twig")
     */
